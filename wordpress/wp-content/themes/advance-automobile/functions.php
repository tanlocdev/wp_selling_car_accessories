...
if ( ! function_exists( 'advance_automobile_related_posts' ) ) {
	function advance_automobile_related_posts() {
		wp_reset_postdata();
		global $post;
		$args = array(
			'no_found_rows'          => true,
			...
			'posts_per_page'    => absint( get_theme_mod( 'advance_automobile_related_posts_number', '3' ) ),
		);
		// Categories
		if ( get_theme_mod( 'advance_automobile_related_posts_taxanomies_options', 'categories' ) == 'categories' ) {
		...
		// Tags
		if ( get_theme_mod( 'advance_automobile_related_posts_taxanomies_options', 'categories' ) == 'tags' ) {
