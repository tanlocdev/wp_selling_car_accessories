...
function advance_automobile_customize_register($wp_customize) {
    ...
    $wp_customize->add_setting( 'advance_automobile_loader_background_color_settings', array(
	    'default' => '#222',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'advance_automobile_loader_background_color_settings', array(
  		'label' => __('Preloader Background Color', 'advance-automobile'),
	    'section' => 'advance_automobile_left_right',
	    'settings' => 'advance_automobile_loader_background_color_settings',
  	)));
