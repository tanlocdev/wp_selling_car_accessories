<?php
	...
	$advance_automobile_loader_background_color_settings = get_theme_mod('advance_automobile_loader_background_color_settings');
	$advance_automobile_custom_css .='#loader-wrapper .loader-section{';
		$advance_automobile_custom_css .='background-color: '.esc_attr($advance_automobile_loader_background_color_settings).';';
	$advance_automobile_custom_css .='} ';
